...
%include '/folders/myshortcuts/myfolder/repro/buildModel/secondPhase/nominal_to_binary.sas';
%include '/folders/myshortcuts/myfolder/repro/buildModel/secondPhase/adadot.sas';
Data temhalfset;
set &name;
run;
