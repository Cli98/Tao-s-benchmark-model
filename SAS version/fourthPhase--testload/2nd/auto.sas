...
%include '/folders/myshortcuts/myfolder/repro/buildModel/fourthPhase--testload/2nd/nominal_to_binary.sas';
%include '/folders/myshortcuts/myfolder/repro/buildModel/fourthPhase--testload/2nd/adadot.sas';
Data temhalfset;
set &name;
run;
