libname repro '/folders/myshortcuts/myfolder/repro/buildModel/fourthPhase--testload/3rd';
%include '/folders/myshortcuts/myfolder/repro/buildModel/fourthPhase--testload/3rd/auto.sas';
...
*check cv result for correct id ;
	%iniseq();
