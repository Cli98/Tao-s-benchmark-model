...
%include '/folders/myshortcuts/myfolder/repro/buildModel/fourthPhase--testload/3rd/nominal_to_binary.sas';
%include '/folders/myshortcuts/myfolder/repro/buildModel/fourthPhase--testload/3rd/adadot.sas';
Data temhalfset;
set &name;
run;
